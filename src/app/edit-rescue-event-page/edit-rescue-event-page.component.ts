...
@Component({
  selector: 'app-edit-rescue-event-page',
  standalone: true,
  imports: [
    MatInputModule,
    MatButtonModule,
  ...
  templateUrl: './edit-rescue-event-page.component.html',
  styleUrl: './edit-rescue-event-page.component.scss'
})
export class EditRescueEventPageComponent implements OnInit{
  ...
  loadEvent(id: string): void {
    this.eventsService.getRescueEventById(id).subscribe(event => {
  ...
  updateEvent(): void {
    ...
    this.eventsService.editRescueEventById(this.currentEventId, updatedEvent).subscribe({
      next: () => {
